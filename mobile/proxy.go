...
import (
	...
	"github.com/0x3f97/martian/v3/api"
	"github.com/0x3f97/martian/v3/cors"
	"github.com/0x3f97/martian/v3/cybervillains"
	"github.com/0x3f97/martian/v3/fifo"
	"github.com/0x3f97/martian/v3/har"
	"github.com/0x3f97/martian/v3/httpspec"
	mlog "github.com/0x3f97/martian/v3/log"
	"github.com/0x3f97/martian/v3/marbl"
	"github.com/0x3f97/martian/v3/martianhttp"
	"github.com/0x3f97/martian/v3/mitm"
	"github.com/0x3f97/martian/v3/servemux"
	"github.com/0x3f97/martian/v3/trafficshape"
	"github.com/0x3f97/martian/v3/verify"

	// side-effect importing to register with JSON API
	_ "github.com/0x3f97/martian/v3/body"
	_ "github.com/0x3f97/martian/v3/cookie"
	_ "github.com/0x3f97/martian/v3/failure"
	_ "github.com/0x3f97/martian/v3/header"
	_ "github.com/0x3f97/martian/v3/martianurl"
	_ "github.com/0x3f97/martian/v3/method"
	_ "github.com/0x3f97/martian/v3/pingback"
	_ "github.com/0x3f97/martian/v3/port"
	_ "github.com/0x3f97/martian/v3/priority"
	_ "github.com/0x3f97/martian/v3/querystring"
	_ "github.com/0x3f97/martian/v3/skip"
	_ "github.com/0x3f97/martian/v3/stash"
	_ "github.com/0x3f97/martian/v3/static"
	_ "github.com/0x3f97/martian/v3/status"
)
