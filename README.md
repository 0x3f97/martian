...
Martian Proxy can be installed using `go install`
    ...
    go get github.com/0x3f97/martian/ && \
    go install github.com/0x3f97/martian/cmd/proxy
...
modifier](https://github.com/0x3f97/martian/wiki/Modifier-Reference#logging) is
...
* `[package.Type]`: The package.Type of the modifier that you want to use. In
  ...
  refer to the [modifier reference](https://github.com/0x3f97/martian/wiki/Modifier-Reference)).
...
[`martian.go`](https://github.com/0x3f97/martian/blob/master/martian.go)).
